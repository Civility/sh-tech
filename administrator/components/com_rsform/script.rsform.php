...
.red {
	...
	<div class="span10">
		...
		<ul class="version-history">
            <li><span class="version-new">New</span> Can now limit the number of selections in a Checkbox Group field.</li>
            <li><span class="version-new">New</span> Permissions: Access Forms, Directory, Submissions, Backup and Restore.</li>
            <li><span class="version-new">New</span> Multi-language can now be disabled from the Configuration area.</li>
            <li><span class="version-new">New</span> Can now import submissions from a CSV file.</li>
            <li><span class="version-new">New</span> Ability to select the default 'Form Layout' for newly created forms.</li>
            <li><span class="version-new">New</span> Ability to select the default 'Load Layout CSS / JS' option for newly created forms.</li>
            <li><span class="version-new">New</span> 'Deletion Email' which can be sent when a submission is deleted from the frontend.</li>
            <li><span class="version-new">New</span> Placeholder {global:language} to display the language code a submission was made in.</li>
            <li><span class="version-upgraded">Upg</span> Moved admin assets to /media/com_rsform/</li>
            <li><span class="version-upgraded">Upg</span> Added new triggers for layouts: rsfp_bk_onLayoutsDefine which allows programmatically removing or adding new layouts.</li>
            <li><span class="version-upgraded">Upg</span> SEF URLs can now be translated.</li>
            <li><span class="version-upgraded">Upg</span> Exporting submissions to a CSV file will show the preview above the tabs.</li>
            <li><span class="version-upgraded">Upg</span> 'New' toolbar button now creates an empty form - the 'Wizard' has been moved to a separate button.</li>
            <li><span class="version-upgraded">Upg</span> File Upload fields have new options: 'Allow Only Images' and thumbnail creation.</li>
            <li><span class="version-upgraded">Upg</span> Can remove uploaded file when editing a submission in the frontend.</li>
            <li><span class="version-upgraded">Upg</span> UIkit updated to 3.0.0-rc25.</li>
            <li><span class="version-upgraded">Upg</span> UIkit 3.0 File Upload now shows the filename in a textbox.</li>
            <li><span class="version-upgraded">Upg</span> {if} scripting allows comparing two placeholders.</li>
			<li><span class="version-upgraded">Upg</span> Various backend CSS &amp; JS optimizations.</li>
            <li><span class="version-upgraded">Upg</span> Some old code has been removed.</li>
            <li><span class="version-fixed">Fix</span> Can now use 0 as a valid value for required items (except for the Range Slider).</li>
            <li><span class="version-fixed">Fix</span> Searching or sorting in the 'Submissions Directory' menu item now resets to the first page.</li>
            <li><span class="version-fixed">Fix</span> The 'autofocus' attribute on elements was overriding the 'Scroll To Form On Error' setting.</li>
            <li><span class="version-fixed">Fix</span> Character count in Textarea fields would show an incorrect value when submitting the form.</li>
            <li><span class="version-fixed">Fix</span> Restoring a form did not work if field names were set as numeric values.</li>
            <li><span class="version-fixed">Fix</span> Configuration area was still accessible even if users had no 'Configure ACL &amp; Options' permission.</li>
            <li><span class="version-fixed">Fix</span> The 'Connect' button was still visible after making a Mappings connection.</li>
            <li><span class="version-fixed">Fix</span> In some cases field properties were not being saved when using multiple languages.</li>
            <li><span class="version-fixed">Fix</span> Additional Emails translations were not being duplicated when duplicating a form.</li>
            <li><span class="version-fixed">Fix</span> In some cases, when editing a submission in the backend the uploaded files were not saved.</li>
            <li><span class="version-fixed">Fix</span> When editing a form, clicking on Directory or Submissions would perform form saving validations instead of simply redirecting.</li>
            <li><span class="version-fixed">Fix</span> When a Form Name is not supplied you are now redirected straight to the field to fix the error.</li>
            <li><span class="version-fixed">Fix</span> Date and Time Picker could not be validated when a Default Value was set.</li>
		</ul>
