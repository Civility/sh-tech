...
<a href="#list-<?=$this->item->id;?>" aria-controls="#list-<?=$this->item->id;?>" data-toggle="collapse" data-toggle="button" class="link list-group-item" role="button" aria-expanded="false" aria-label="<?=JText::_('JGLOBAL_EXPAND_CATEGORIES'); ?>">
